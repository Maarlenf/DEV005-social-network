...
const firebaseConfig = {
  apiKey: "AIzaSyAch6SFhgqlFOIE3VB5UH09wnwv5vSUIOU",
  authDomain: "proyect-socialnetwork-mi.firebaseapp.com",
  projectId: "proyect-socialnetwork-mi",
  storageBucket: "proyect-socialnetwork-mi.appspot.com",
  messagingSenderId: "3849041689",
  appId: "1:3849041689:web:3f9c7d3c19554b416cf788",
  measurementId: "G-TM53PDJKJD"
};
const app = initializeApp(firebaseConfig);
const auth = getAuth();
const db = wh(app);
const logo = "/assets/logo.faa67660.png";
const start = (email, password) => new Promise((resolve, reject) => {
  const auth2 = getAuth();
  ...
  signInWithEmailAndPassword(auth2, email, password).then((userCredential) => {
    ...
    if (errorCode === "auth/wrong-password") {
      pError.textContent = "Correo o contrase\xF1a inv\xE1lida.";
...
function home() {
  ...
  labelPass.textContent = "Contrase\xF1a";
  ...
  pSingUp.textContent = "\xBFA\xFAn no tienes Cuenta? ";
  pSingUp.className = "pSingup";
  aLink.className = "aRegister";
  aLink.href = "/register";
  aLink.textContent = " Reg\xEDstrate";
  pGoogle.textContent = "Tambi\xE9n Puedes";
...
function error() {
  ...
  img.alt = "Logo Cocktail Network";
  img.className = "login";
  textError.textContent = "P\xE1gina no encontrada. Por favor dir\xEDgete a la p\xE1gina de";
...
const addAccount = (email, password) => {
  ...
  createUserWithEmailAndPassword(auth2, email, password).then((userCredential) => {
    ...
    if (errorCode === "auth/weak-password") {
      change.innerHTML = "La constrase\xF1a ingresada es demasiado d\xE9bil.";
    } else if (errorCode === "auth/email-already-in-use") {
      change.innerHTML = "El correo ingresado ya esta en uso.";
    } else if (errorCode === "auth/invalid-email") {
      change.innerHTML = "El correo ingresado no es v\xE1lido.";
    }
  });
};
function register() {
  ...
  labelpassUp.textContent = "Contrase\xF1a";
  ...
  divAling.className = "aling";
  pSingUp.textContent = "\xBFYa tienes una cuenta?. Regresa al";
  pSingUp.className = "pSingup";
...
const collectionPost = sh(db, "postCocktailNetwork");
const postIt = (nameCock, ingredients, preparation, date, likes) => uf(sh(db, "postCocktailNetwork"), {
  inLine: watchUser(),
  nameCock,
  ingredients,
  preparation,
...
tf(collectionPost);
const createSanpshot = (callback) => cf(dl(collectionPost, Il("date", "desc")), callback);
const countLike = (id2, user) => rf(rh(db, "postCocktailNetwork", id2), { likes: Sf(user) });
const removeLike = (id2, user) => rf(rh(db, "postCocktailNetwork", id2), { likes: Df(user) });
const updatePost = (id2, nameCock, ingredients, preparation) => rf(rh(db, "postCocktailNetwork", id2), {
  nameCock,
  ingredients,
  preparation
});
const removePost = (data) => of(rh(db, "postCocktailNetwork", data));
function wall() {
  ...
  textAreaPrepa.placeholder = "Preparaci\xF3n";
  ...
  createSanpshot((querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      prepaPost.textContent = "Preparaci\xF3n";
      ...
      messageAlert.textContent = "Al realizar esta acci\xF3n se eliminar\xE1 de forma permanente tu Cocktail. \xBFEst\xE1s seguro que lo quieres eliminar?";
      ...
      prepaPostEdit.textContent = "Preparaci\xF3n";
